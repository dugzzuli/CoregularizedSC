function [V E F P R nmi avgent AR C M] = baseline_spectral_onkernel(K,numClust,truth,projev)
% INPUT:
...
%         accuracy(i) = 1-Misclassification(truth,C);
        if (min(truth)==0)
